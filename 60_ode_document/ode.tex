...
\subsubsection{How are all contributors acknowledged or credited (e.g., CRediT taxonomy)?} The contributors are listed as authors in the ODE document. The contributions are distributed as follows: ... % todo: add contributions paragraph
